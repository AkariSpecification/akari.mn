  ...
  <div class="flex flex-col h-screen">
    ...
    <div class="flex mx-4">
      <div class="flex flex-col w-full h-screen bg-gray-white w-full">
        ...
        <p>
          CISC like Intel is converting CISC variable length instruction to RISC
          like micro code.
        </p>
        <p>So it need converting circuit and die size becomes large.</p>
        <p>
          So there is overhead like consumption of electricity becomes large.
        </p>
        <p>
          On the other hand, ARM and RISC-V is same as means of if code runs
          these machine, it must run forever but Instruction Set is simple and
          it can use relatively new technology.
        </p>
        <p>
        ...
        <p>
          So if application that runs only on Intel can run on RISC-V or ARM by
          very optimized way,it may be very advantagerous.
        </p>
        <br />
        <p>
          So if we want to run application for Intel x86-64 on RISC-V or ARM by
          very optimized way, it need to port Intel intrinsic function to RISC-V
          or ARM.
        </p>
        ...
        <p>
          Intel Intrinsic API provide Instruction Set Extension Intel continue
          to provide.
        </p>
        <p>SIMD(Single Instruction Stream Multiple Data Stream) is included.</p>
        <p>
          To port Intel x86-64 function to RISC-V like IBM POWER takes specific
          wrap structure like below.
        </p>
        <pre
...
_mm_add_pd (__m128d __A, __m128d __B)
{
   return (__m128d) ((__v2df)__A + (__v2df)__B);
        ...
        <p>
          _mm_add_pd is Intel Intrinsic function and this function add __A and
          __B.
        </p>
        <p>
...
_mm_set1_pd (double __F)
{
   return __extension__ (__m128d){ __F, __F };
        ...
        <p>
          So we input Intel and RISC-V like IBM POWER or ARM the same value and
          make sure output is same.
        </p>
        <!-- Developer -->
        <div class="w-full">
          ...
          <ul class="list-disc list-inside">
            <li class="my-4 break-words break-all">
              <a href="https://github.com/daisukeokaoss" class="text-blue-600"
                >Oka Daisuke</a
              >
              <p>
            ...
            <li>
              <a href="https://github.com/takahashi-akari" class="text-blue-600"
                >Takahashi Akari</a
              >
              <p>I'm a software engineer. I'm interested in programming languages, compilers, and operating systems. I'm also interested in web development and machine learning.</p>
            </li>
          </ul>
        </div>
        <!-- footer -->
