  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: "og:title", content: "AkariSpecification(Port Intel x86-64 intrinsic function to RISC-V or ARM)" },
        { property: "og:description", content: "Port Intel x86-64 intrinsic function to RISC-V or ARM" },
        {
